		...
		<div id="list-award" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:sortableColumn property="type" title="${message(code: 'award.type.label', default: 'Type')}" /></th>
						
						<th><g:sortableColumn property="awardDate" title="${message(code: 'award.checkinDate.label', default: 'Award Date')}" /></th>
					
						<th><g:message code="award.customer.label" default="Phone" /></th>
					
						<th><g:sortableColumn property="points" title="${message(code: 'award.points.label', default: 'Points')}" /></th>
